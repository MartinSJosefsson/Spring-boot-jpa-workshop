...
public class AppUserRepositoryTest {
    ...
    @Autowired
    // Spring core annotation used for dependency injection to create the bean/instance of field  in the IOC container , can be injected in setter ,field or constructor
